...
{
    public class ProductDeliverSizeConfig : IEntityTypeConfiguration<ProductDeliverSize>
    {        
        public void Configure(EntityTypeBuilder<ProductDeliverSize> builder)
        {
            builder.ToTable(TableNameCreator.CreateTableName(nameof(ProductDeliverSize)));
